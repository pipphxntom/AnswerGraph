"""
Example script demonstrating how to use the policy loading functions.

This script shows how to load policies from JSON files into the database
in your own application code.
"""
import asyncio
import logging
from src.scripts.process_excel_templates import load_policy_json, load_dir
